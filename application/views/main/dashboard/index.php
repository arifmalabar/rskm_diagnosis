    ...
    <div class="col-md-4">
        <!-- Info Boxes Style 2 -->
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Status Gizi Baik</span>
              <span class="info-box-number"><?= $gizi_baik ?></span>
          ...
          <div class="info-box bg-red">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Status Obesitas</span>
              <span class="info-box-number"><?= $gizi_obesitas ?></span>
